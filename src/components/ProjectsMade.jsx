    ...
    switch (activeTab) {
          ...
          <div className="text-white">
              ...
              {[
                {
                  id: 1,
                  imgSrc:
                    "../projects/graphics/Flyer for Telegram Channel v2.jpg",
                ...
                <div key={project.id} className="relative group">
                  ...
                  />
                  <div className="w-11/12 h-full absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg"onClick= {() => handleImageClick(project.imgSrc)}>
            ...
            {selectedImage && (
              <div
                ...
                onClick={handleClosePopup} // Close popup when clicking outside the image
              >
                <div className="relative max-w-[90%] max-h-[90vh]"
                  ...
                  <img
                    ...
                    className="max-w-[90%] max-h-[90vh] rounded-lg object-contain"
                    onContextMenu={(e) => e.preventDefault()} // Prevent right-click context menu
                    draggable="false" // Prevent dragging
                  />
                  <button
                    className="absolute top-[-20px] right-[-20px] text-white text-2xl font-bold"
                    onClick={handleClosePopup} // Close popup when clicking the close button
                  >
                    &times;
                  </button>
                </div>
      ...
      case "third":
        return (
          <div className="text-white">
            <p className="mb-6 text-xl text-center font-semibold">
              Dive into groundbreaking deep learning projects that demonstrate
              ...
              {[
                {
                  ...
                  title:
                    "Deep Learning Based Image Classification and Information App for Ethiopian Traditional Medicinal Plants (ETMPs)",
                  description:
